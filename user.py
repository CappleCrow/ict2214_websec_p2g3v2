...
def get_downloads_folder():
    ...
    try:
        ...
        # Fallback to a temporary folder on Linux/Unix systems (or Windows' temp directory)
...
def home():
    try:
        ...
        # Catch any unhandled exceptions and display them as error_message
        error_message = f"Internal Server Error: {str(e)}"
        return render_template("validate_api_request.html", response_text="", error_message=error_message, conversation=session.get("conversation", [])), 500
